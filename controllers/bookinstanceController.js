...
// Display detail page for a spectific BookInstance.
...
exports.bookinstance_update_get = asyncHandler(async (req, res, next ) => {
    ...
    if (instance === null) {
      // No results.
      const err = new Error("Book instance not fond");
      err.status = 404;
      return next(err);
    }
...
exports.bookinstance_update_post = [
    ...
    asyncHandler(async(req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            ...
            const theinstance = await BookInstance.findByIdAndUpdate(req.params.id, instance);
